...
const basePath = '/cnno-1775453266333';
...
export default function Home() {
  ...
  const products = [{ n: 'OG Rolls', d: 'Our signature cinnamon rolls, handcrafted with love and care, featuring a perfect blend of sweet and spicy flavors. Made with high-quality ingredients and a touch of artisanal technique, our OG Rolls are a must-try for anyone looking to indulge in a classic treat.', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80', icon: 'domain' }, { n: 'Pistachio Rolls', d: 'A unique twist on our classic rolls, our Pistachio Rolls feature a delicate pistachio flavor and a soft, fluffy texture. Perfect for adventurous eaters and nut lovers alike, these rolls are sure to satisfy your cravings.', i: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1200&q=80', icon: 'architecture' }, { n: 'Chocolate Rolls', d: 'For all you chocolate lovers out there, our Chocolate Rolls are a dream come true. Featuring rich, velvety chocolate and a hint of cinnamon, these rolls are the perfect treat to brighten up your day.', i: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1200&q=80', icon: 'chair' }, { n: 'Baby Rolls', d: 'Bite-sized and adorable, our Baby Rolls are perfect for snacking on the go. With a variety of flavors to choose from, these little treats are sure to put a smile on your face.', i: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=1200&q=80', icon: 'eco' }, { n: 'Party Box', d: 'Looking to impress your friends and family with a delicious and unique treat? Our Party Box features a selection of our finest rolls, perfect for any occasion. With a variety of flavors and a beautiful presentation, this box is sure to be a hit.', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft artisanal cinnamon rolls that bring warmth and comfort to our community, one delicious bite at a time.</p>
                </div>
                <div className="space-y-2">
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              ...
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=1200&q=80" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
